...
### Changed
- StigForge export refresh for `rhel8_cis` at `0.3.0`.

### Verified (OpenSCAP)

- **`cis-l1`** — score **96.51%** (floor 90.0%) · gate **PASS** · evidence `20260912T133523Z`
  - Remaining counted failures: `accounts_password_pam_modules_in_authselect_profile, no_files_or_dirs_ungroupowned, use_pam_wheel_group_for_su`
- **`cis-l2`** — score **96.67%** (floor 90.0%) · gate **PASS** · evidence `20260912T133825Z`
  - Remaining counted failures: `accounts_password_pam_modules_in_authselect_profile, no_files_or_dirs_ungroupowned, use_pam_wheel_group_for_su`
- **`cis-ws-l1`** — score **96.51%** (floor 90.0%) · gate **PASS** · evidence `20260912T134025Z`
  - Remaining counted failures: `accounts_password_pam_modules_in_authselect_profile, no_files_or_dirs_ungroupowned, use_pam_wheel_group_for_su`
- **`cis-ws-l2`** — score **96.63%** (floor 90.0%) · gate **PASS** · evidence `20260912T134326Z`
  - Remaining counted failures: `accounts_password_pam_modules_in_authselect_profile, no_files_or_dirs_ungroupowned, use_pam_wheel_group_for_su`
